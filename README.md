...
При установке будет задан вопрос, где расположить DLL файлы? Расположить их можно и в директории системы, и в папке bin внутри папки с установленной OpenSSL.  
https://slproweb.com/products/Win32OpenSSL.html  
