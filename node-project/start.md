...
Расширение файла mjs - это стандарт ECMAScript для модульных систем и серверных сред.  

"start": "nodemon index.mjs" запуск nodemon через команду npm start, после этого изменения о nodemon можно будет забыть.
