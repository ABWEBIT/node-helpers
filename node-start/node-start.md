...
В процессе установки ничего менять не надо, все нужные компоненты уже выбраны. После выбора компонентов, установщик предложит установить дополнительные инструментов, для базовой настройки и простой работы они не требуются, можно пропустить.
