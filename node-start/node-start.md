## Подготовка NodeJS для разработки в Windows 11 с помощью Visual Studio Code
...
Код стандартный и вникать в него не надо, готовый блок кода можно взять с сайта NodeJS. https://nodejs.org/
